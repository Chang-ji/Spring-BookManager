...
//        author2.addBook(book2, book3, book4);
        ...
        bookRepository.findByName("개발책1").getBookAndAuthors().forEach(System.out::println);
        System.out.println("books through author : -------------------------------");
        authorRepository.findByName("martin").getBookAndAuthors().forEach(System.out::println);
    }
